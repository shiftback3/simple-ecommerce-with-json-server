<template>
  <div class="home">
    ...
    <div id="wrapper" class="wrapper">
      ...
      <div class="tm-heroslider-area">
        ...
        <ul class="tm-heroslider-social">
          <li>
            <a href="#" title="facebook"><i class="ti ti-facebook"></i></a>
            <span class="tm-heroslider-social-tooltip">Facebook</span>
          </li>
          <li>
            <a href="#" title="twitter"><i class="ti ti-twitter-alt"></i></a>
            <span class="tm-heroslider-social-tooltip">Twitter</span>
          </li>
          <li>
            <a href="#" title="pinterest"><i class="ti ti-pinterest"></i></a>
      ...
      <main class="page-content">
        ...
        <section
          id="tm-about-area"
          class="tm-section tm-about-area tm-padding-section bg-white"
          data-bgimage="assets/images/about-bg-image.png"
        ...
        >
          <div class="container">
              ...
              <div class="col-xl-6 col-lg-8 col-md-9 col-12">
                <div class="tm-sectiontitle text-center">
                  ...
                  <span class="tm-sectiontitle-divider">
                    <img
                      src="assets/images/section-divider-icon.png"
                      alt="section divider"
                    />
                  </span>
                  <p>
            ...
            <div
              class="tm-about tm-scrollanim"
              data-bgimage="assets/images/about-block-background.png"
            >
              <div class="row">
        ...
        <!-- Video Area -->
        <div
          class="tm-section tm-video-area"
          data-bgimage="assets/images/video-area-background.jpg"
          data-overlay="3"
        >
          <div class="container">
        ...
        <div
          id="tm-service-area"
          class="tm-section tm-service-area tm-padding-section bg-white"
        >
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-8 col-md-9 col-12">
              ...
              <div class="col-lg-4 col-md-6 col-12">
                <div class="tm-service text-center tm-scrollanim">
                  ...
                  <p>
                    ...
                    tincidunt ultrices utquis blandit dolor.
                  </p>
              ...
              <div class="col-lg-6">
                <div class="tm-pricing">
                  ...
                  <p>
                    ...
                    called make-up or makeup. Makeup services price below:
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      <span class="name">Face Brushes</span>
                      <span class="price">$ 85.00</span>
                    </li>
                    <li>
                      <span class="name">Face Powder</span>
                      <span class="price">$ 55.00</span>
                    </li>
                    <li>
                      <span class="name">Face Primer</span>
                      <span class="price">$ 99.00</span>
                    </li>
                    <li>
                      <span class="name">Bronzer</span>
                      <span class="price">$ 100.00</span>
                    </li>
                    <li>
                      <span class="name">Luminizer</span>
                      <span class="price">$ 120.00</span>
                    </li>
                  </ul>
                  <a href="#appointment-area" class="tm-button hash-scroll-link"
                    >Book now</a
                  >
                </div>
              </div>
        ...
        <div
          id="appointment-area"
          class="tm-section tm-appointment-area tm-padding-section bg-white"
            ...
            <div class="row align-items-end">
              ...
              <div class="col-lg-6 col-12 order-1 order-lg-2">
                <div class="tm-appointment-box">
                  ...
                  <p>
                    One of our experts will get back to you soon and answer any questions
                    you may have.
                  </p>
                  <form
                    action="https://thememarch.com/demo/html/munu/munu/assets/php/appointment.php"
                    id="tm-appointment-form"
                    class="tm-appointment-form tm-form tm-form-whitebox"
                    method="post"
                  >
        ...
        <div
          id="tm-shop-area"
          class="tm-section tm-products-area tm-padding-section bg-white"
          data-bgimage="assets/images/products-bg-shape.png"
        ...
        >
          <div class="container">
              ...
              >
                <div class="tm-product">
                  ...
                  <div class="tm-product-bottomside">
                    ...
                    <span class="tm-product-price"> N {{ product.price }}</span>
            ...
            <div class="tm-products-viewmore text-center mt-50">
              <a href="#" class="tm-button">View More</a>
            </div>
          </div>
        </div>
        <!--// Products Area -->
            ...
            <div class="row align-items-center">
              <div class="col-lg-6 col-12 order-2 order-lg-1">
                <div class="tm-offer-left tm-scrollanim">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diamusus
                    nonummy nibh euismod tincidunt ut laoreet dolore magn aliquam erat
                    volutpat. Ut wisi enim ad min que. Pellent maximus exet velit
                    tincidunt in pharetra
                  </p>
        ...
        <!-- Testimonial Area -->
        <div
          class="tm-section tm-testimonial-area tm-padding-section bg-white"
          data-white-overlay="8"
            ...
            <div class="tm-testimonial-wrapper tm-testimonial-slider tm-scrollanim">
              ...
              <div class="tm-testimonial">
                ...
                <p>
                  ...
                  sollicitudin nulla tempor congue. Integer sed elementum odio. Quisque
                  ullamcorper quis sapien eget lobortis. Vivamus sodales varius turpis.
                </p>
              ...
              <div class="tm-testimonial">
                ...
                <p>
                  Suscipit nobis quo ut qui rerum. Quia fugit voluptate quis totam. Iure
                  qui dolorem quisquam placeat facilis ut et. Nisi et necessitatibus sequi
                  cumque. Quasi laudantium asperiores et qui voluptas odio. Eum quo nam
                  distinctio. Aut atque perspiciatis nobis id non modi maxime repellendus
                  et.
                </p>
                <div class="tm-testimonial-author">
                  <h6>Hosea Hilll</h6>
              ...
              <div class="tm-testimonial">
                <span class="tm-testimonial-authorimage">
                  <img src="assets/images/author-image-3.png" alt="author image" />
                </span>
                <p>
                  Et illum consequatur. Optio sunt et aut. Voluptatem assumenda maiores
                  aut vitae ut. Pariatur placeat necessitatibus modi vero enim velit. Qui
                  error qui eligendi reprehenderit rem autem. Laboriosam accusantium a.
                  Unde magnam dolorem occaecati. Qui earum architecto expedita.
                </p>
                <div class="tm-testimonial-author">
                  <h6>Abbey Douglas</h6>
                  <span>Client</span>
        ...
        <!-- Subscribe Area -->
        <div
          class="tm-section tm-subscribe-area tm-padding-section bg-grey"
          data-bgimage="assets/images/subscribe-bg-image.png"
        >
          <div class="container">
            <div class="row justify-content-center">
        ...
        <!-- Team Members -->
        <div class="tm-section tm-member-area tm-padding-section bg-white">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-8 col-md-9 col-12">
                <div class="tm-sectiontitle text-center">
            ...
            <div class="row tm-member-slider">
              <!-- Single Team Member -->
              <div class="col-lg-4">
                <div class="tm-member tm-scrollanim">
            ...
            <div class="row tm-portfolio-wrapper mt-30-reverse">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-1.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Self makeup at home"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-1.jpg"
                      alt="portfolio image"
                    />
                  </a>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  ...
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-5.jpg"
                      alt="portfolio image"
                    />
                  </a>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-2.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Leapstick"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-2.jpg"
                      alt="portfolio image"
                    />
                  </a>
                  <span class="tm-portfolio-icon"><i class="ti ti-fullscreen"></i></span>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-3.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Face Treatment"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-3.jpg"
                      alt="portfolio image"
                    />
                  </a>
                  <span class="tm-portfolio-icon"><i class="ti ti-fullscreen"></i></span>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-4.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Clean Face"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-4.jpg"
                      alt="portfolio image"
                    />
                  </a>
                  <span class="tm-portfolio-icon"><i class="ti ti-fullscreen"></i></span>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-6.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Cleaning Face"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-6.jpg"
                      alt="portfolio image"
                    />
                  </a>
                  <span class="tm-portfolio-icon"><i class="ti ti-fullscreen"></i></span>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-7.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Art Leapstick"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-7.jpg"
                      alt="portfolio image"
                    />
                  </a>
                  <span class="tm-portfolio-icon"><i class="ti ti-fullscreen"></i></span>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-30">
                <div class="tm-portfolio tm-scrollanim">
                  <a
                    href="assets/images/portfolio/portfolio-image-lg-8.jpg"
                    data-fancybox="portfolio-gallery"
                    data-caption="Skin treatment"
                  >
                    <img
                      src="assets/images/portfolio/portfolio-image-8.jpg"
                      alt="portfolio image"
                    />
                  </a>
                  <span class="tm-portfolio-icon"><i class="ti ti-fullscreen"></i></span>
        ...
        <!-- Faq Area -->
        <div
          class="tm-section tm-faq-area tm-padding-section bg-white"
          data-bgimage="assets/images/faq-bg-image.jpg"
          ...
          <div class="container">
            ...
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10 col-12">
                <div class="tm-faq-tabs text-center">
                ...
                <div class="tab-content" id="bstab1-ontent">
                  ...
                  >
                    ...
                    <div id="tm-accordion-1" class="tm-accordion">
                      <div class="card">
                        <div class="card-header" id="tm-accordion-1-heading-1">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link"
                              data-toggle="collapse"
                              data-target="#tm-accordion-1-collapse-1"
                              aria-expanded="true"
                              aria-controls="tm-accordion-1-collapse-1"
                            >
                              What is Munu Beauty?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-1-collapse-1"
                          class="collapse show"
                          aria-labelledby="tm-accordion-1-heading-1"
                          data-parent="#tm-accordion-1"
                        >
                          <div class="card-body">
                            <p>
                              Lorem ipsum dolor consectetur adipiscing Fusce varius
                              euismod lacus eget feugiat rorem lorem ipsum dolor sit amet,
                              consectetuer adipiscing elit. Aenean commodo ligula eget
                              dolor massa sociis natoque penatibus. ipsum dolor
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-1-heading-2">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-1-collapse-2"
                              aria-expanded="false"
                              aria-controls="tm-accordion-1-collapse-2"
                            >
                        ...
                        <div
                          id="tm-accordion-1-collapse-2"
                          class="collapse"
                          aria-labelledby="tm-accordion-1-heading-2"
                          data-parent="#tm-accordion-1"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-1-heading-3">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-1-collapse-3"
                              aria-expanded="false"
                              aria-controls="tm-accordion-1-collapse-3"
                            >
                        ...
                        <div
                          id="tm-accordion-1-collapse-3"
                          class="collapse"
                          aria-labelledby="tm-accordion-1-heading-3"
                          data-parent="#tm-accordion-1"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-1-heading-4">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-1-collapse-4"
                              aria-expanded="false"
                              aria-controls="tm-accordion-1-collapse-4"
                            >
                              What do I do if my order shows as delivered but I have not
                              received it?
                            </button>
                          </h5>
                        </div>
                        <div
                          id="tm-accordion-1-collapse-4"
                          class="collapse"
                          aria-labelledby="tm-accordion-1-heading-4"
                          data-parent="#tm-accordion-1"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-1-heading-5">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-1-collapse-5"
                              aria-expanded="false"
                              aria-controls="tm-accordion-1-collapse-5"
                            >
                              The item I have ordered is not currently in stock how long
                              will it take to be dispatched?
                            </button>
                          </h5>
                        </div>
                        <div
                          id="tm-accordion-1-collapse-5"
                          class="collapse"
                          aria-labelledby="tm-accordion-1-heading-5"
                          data-parent="#tm-accordion-1"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-1-heading-6">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-1-collapse-6"
                              aria-expanded="false"
                              aria-controls="tm-accordion-1-collapse-6"
                            >
                        ...
                        <div
                          id="tm-accordion-1-collapse-6"
                          class="collapse"
                          aria-labelledby="tm-accordion-1-heading-6"
                          data-parent="#tm-accordion-1"
                        >
                          <div class="card-body">
                            <p>
                  ...
                  >
                    <!-- Accordion -->
                    <div id="tm-accordion-2" class="tm-accordion">
                      <div class="card">
                        <div class="card-header" id="tm-accordion-2-heading-1">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link"
                              data-toggle="collapse"
                              data-target="#tm-accordion-2-collapse-1"
                              aria-expanded="true"
                              aria-controls="tm-accordion-2-collapse-1"
                            >
                              What is Munu Beauty?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-2-collapse-1"
                          class="collapse show"
                          aria-labelledby="tm-accordion-2-heading-1"
                          data-parent="#tm-accordion-2"
                        >
                          <div class="card-body">
                            <p>
                              Lorem ipsum dolor consectetur adipiscing Fusce varius
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-2-heading-2">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-2-collapse-2"
                              aria-expanded="false"
                              aria-controls="tm-accordion-2-collapse-2"
                            >
                              When is your next promotion?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-2-collapse-2"
                          class="collapse"
                          aria-labelledby="tm-accordion-2-heading-2"
                          data-parent="#tm-accordion-2"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-2-heading-3">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-2-collapse-3"
                              aria-expanded="false"
                              aria-controls="tm-accordion-2-collapse-3"
                            >
                              How can I track my order?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-2-collapse-3"
                          class="collapse"
                          aria-labelledby="tm-accordion-2-heading-3"
                          data-parent="#tm-accordion-2"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-2-heading-4">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-2-collapse-4"
                              aria-expanded="false"
                              aria-controls="tm-accordion-2-collapse-4"
                            >
                              What do I do if my order shows as delivered but I have not
                              received it?
                            </button>
                        ...
                        <div
                          id="tm-accordion-2-collapse-4"
                          class="collapse"
                          aria-labelledby="tm-accordion-2-heading-4"
                          data-parent="#tm-accordion-2"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-2-heading-5">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-2-collapse-5"
                              aria-expanded="false"
                              aria-controls="tm-accordion-2-collapse-5"
                            >
                              The item I have ordered is not currently in stock how long
                              will it take to be dispatched?
                            </button>
                        ...
                        <div
                          id="tm-accordion-2-collapse-5"
                          class="collapse"
                          aria-labelledby="tm-accordion-2-heading-5"
                          data-parent="#tm-accordion-2"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-2-heading-6">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-2-collapse-6"
                              aria-expanded="false"
                              aria-controls="tm-accordion-2-collapse-6"
                            >
                              Can you send samples of your products?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-2-collapse-6"
                          class="collapse"
                          aria-labelledby="tm-accordion-2-heading-6"
                          data-parent="#tm-accordion-2"
                        >
                          <div class="card-body">
                            <p>
                  ...
                  >
                    <!-- Accordion -->
                    <div id="tm-accordion-3" class="tm-accordion">
                      <div class="card">
                        <div class="card-header" id="tm-accordion-3-heading-1">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link"
                              data-toggle="collapse"
                              data-target="#tm-accordion-3-collapse-1"
                              aria-expanded="true"
                              aria-controls="tm-accordion-3-collapse-1"
                            >
                              What is Munu Beauty?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-3-collapse-1"
                          class="collapse show"
                          aria-labelledby="tm-accordion-3-heading-1"
                          data-parent="#tm-accordion-3"
                        >
                          <div class="card-body">
                            <p>
                              Lorem ipsum dolor consectetur adipiscing Fusce varius
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-3-heading-2">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-3-collapse-2"
                              aria-expanded="false"
                              aria-controls="tm-accordion-3-collapse-2"
                            >
                              When is your next promotion?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-3-collapse-2"
                          class="collapse"
                          aria-labelledby="tm-accordion-3-heading-2"
                          data-parent="#tm-accordion-3"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-3-heading-3">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-3-collapse-3"
                              aria-expanded="false"
                              aria-controls="tm-accordion-3-collapse-3"
                            >
                              How can I track my order?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-3-collapse-3"
                          class="collapse"
                          aria-labelledby="tm-accordion-3-heading-3"
                          data-parent="#tm-accordion-3"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-3-heading-4">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-3-collapse-4"
                              aria-expanded="false"
                              aria-controls="tm-accordion-3-collapse-4"
                            >
                              What do I do if my order shows as delivered but I have not
                              received it?
                            </button>
                        ...
                        <div
                          id="tm-accordion-3-collapse-4"
                          class="collapse"
                          aria-labelledby="tm-accordion-3-heading-4"
                          data-parent="#tm-accordion-3"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-3-heading-5">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-3-collapse-5"
                              aria-expanded="false"
                              aria-controls="tm-accordion-3-collapse-5"
                            >
                              The item I have ordered is not currently in stock how long
                              will it take to be dispatched?
                            </button>
                        ...
                        <div
                          id="tm-accordion-3-collapse-5"
                          class="collapse"
                          aria-labelledby="tm-accordion-3-heading-5"
                          data-parent="#tm-accordion-3"
                        >
                          <div class="card-body">
                            <p>
                      ...
                      <div class="card">
                        <div class="card-header" id="tm-accordion-3-heading-6">
                          <h5 class="mb-0">
                            <button
                              class="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#tm-accordion-3-collapse-6"
                              aria-expanded="false"
                              aria-controls="tm-accordion-3-collapse-6"
                            >
                              Can you send samples of your products?
                            </button>
                          </h5>
                        ...
                        <div
                          id="tm-accordion-3-collapse-6"
                          class="collapse"
                          aria-labelledby="tm-accordion-3-heading-6"
                          data-parent="#tm-accordion-3"
                        >
                          <div class="card-body">
                            <p>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="tm-calltoaction-image tm-scrollanim">
                  <img
                    src="assets/images/calltoaction-image.png"
                ...
                <div class="tm-calltoaction-content tm-scrollanim">
                  ...
                  <h4>
                    <a href="tel:+18009156270"
                      ><i class="ti ti-mobile"></i> Call: 18009156270</a
                    >
                  </h4>
                  <h4><span>OR</span></h4>
                  <a href="#contactus-area" class="tm-button hash-scroll-link"
                    >Contact Us</a
                  >
                </div>
              </div>
        ...
        <!-- Contact Us -->
        <div
          id="tm-contactus-area"
          class="tm-section tm-contact-area tm-padding-section bg-white"
          data-bgimage="assets/images/contact-us-background.png"
          data-white-overlay="8"
        >
          <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <div class="tm-contact-address">
                    ...
                    <div class="tm-contact-addressblock">
                      <b>Address</b>
                      <p>
                        Toronto City Hall 123 Queen St W, Toronto, Ontario M1N2O3, Canada.
                      </p>
                    </div>
                    <div class="tm-contact-addressblock">
                      <b>Email</b>
              ...
              <div class="row mt-50-reverse">
                <div class="col-lg-6">
                  <div class="tm-contact-formwrapper mt-50">
                    ...
                    <form
                      id="tm-contactform"
                      action="https://thememarch.com/demo/html/munu/munu/assets/php/mailer.php"
                    ...
                    >
                      <div class="tm-form-inner">
                        ...
                        <div class="tm-form-field">
                          <button type="submit" class="tm-button tm-button-block">
                            Send Now
                          </button>
                        </div>
                      </div>
          ...
          <div class="container">
            <div class="tm-brandlogo-slider">
              ...
              <div class="tm-brandlogo">
                <a href="#">
                  <img src="assets/images/brandlogo/brandlogo-1.png" alt="brand-logo" />
                </a>
              </div>
              <!--// Brang Logo Single -->
              ...
              <div class="tm-brandlogo">
                <a href="#">
                  <img src="assets/images/brandlogo/brandlogo-2.png" alt="brand-logo" />
                </a>
              </div>
              <!--// Brang Logo Single -->
              ...
              <div class="tm-brandlogo">
                <a href="#">
                  <img src="assets/images/brandlogo/brandlogo-3.png" alt="brand-logo" />
                </a>
              </div>
              <!--// Brang Logo Single -->
              ...
              <div class="tm-brandlogo">
                <a href="#">
                  <img src="assets/images/brandlogo/brandlogo-4.png" alt="brand-logo" />
                </a>
              </div>
              <!--// Brang Logo Single -->
              ...
              <div class="tm-brandlogo">
                <a href="#">
                  <img src="assets/images/brandlogo/brandlogo-5.png" alt="brand-logo" />
                </a>
              </div>
              <!--// Brang Logo Single -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                      <div class="tm-prodetails-content">
                        <h4 class="tm-prodetails-title">{{ singleProduct.name }}</h4>
                        <div class="tm-ratingbox">
                          <span class="is-active"><i class="ti ti-star"></i></span>
                          <span class="is-active"><i class="ti ti-star"></i></span>
                          <span class="is-active"><i class="ti ti-star"></i></span>
    ...
    <!--// Wrapper -->
    <div id="snackbar">Item already added to Cart!..</div>
  </div>
</template>
